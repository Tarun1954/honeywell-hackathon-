...
![24-hour electricity and peak comparison](../results/ollama_24h_energy_peak.png)

![24-hour comfort comparison](../results/ollama_24h_comfort.png)

![24-hour action and latency evidence](../results/ollama_24h_actions_latency.png)

Sources:
[JSON](../results/ollama_24h_comparison.json),
[CSV](../results/ollama_24h_comparison.csv), and
...
![Deterministic Phase 1 energy comparison](../results/energy_comparison.png)
...
![Scripted zone temperature and PMV](../results/zone_temperature_pmv.png)

![Scripted action and setpoint evidence](../results/action_setpoint_evidence.png)
